...
CREATE TABLE books (
    ...
    FOREIGN KEY (authors_id) REFERENCES book_authors(id)
);
...
INSERT INTO publishers (pname, address, phone, website) VALUES
...
INSERT INTO books (title, isbn, edition, release_year, price, publisher_id, genre_id, authors_id) VALUES
('The Journey of Self-Discovery', '978-1234567890', 1, 2020, 19.99, 1, 1, 1),
('Secrets Unveiled: A Detective Memoir', '978-0987654321', 2, 2018, 15.99, 2, 2, 3),
('Recipes for Success: Business Strategies Unveiled', '978-9876543210', 1, 2022, 24.99, 1, 3, 5),
('Thriving in the Digital Age: Strategies for Success', '978-5432109876', 1, 2021, 29.99, 3, 4, 4),
('The Art of Mindfulness: Living in the Present', '978-1357924680', 3, 2019, 12.99, 4, 5, 2),
('Pride and Prejudice', '9780141439518', 1, 2000, 9.99, 1, 1, 1), 
('Great Expectations', '9780141439563', 1, 2001, 12.99, 2, 1, 2), 
('The Old Man and the Sea', '9780684801223', 1, 2002, 10.99, 3, 1, 5), 
('Murder on the Orient Express', '9780062693662', 1, 2002, 11.99, 4, 3, 4), 
('The Fellowship of the Ring', '9780547928210', 1, 2004, 15.99, 5, 5, 5), 
('Beloved', '9781400033416', 1, 2005, 14.99, 6, 1, 2), 
('One Hundred Years of Solitude', '9780060883287', 1, 2006, 13.99, 7, 2, 6);
...
(1, 1, '2024-01-01', '2024-06-15', '2024-01-14'),
(2, 2, '2024-01-05', '2024-06-20', NULL),
(3, 3, '2024-01-10', '2024-01-25', NULL),
(4, 4, '2024-01-15', '2024-01-30', NULL),
(1, 5, '2024-01-20', '2024-08-04', NULL),
(6, 6, '2024-02-01', '2024-08-15', NULL),
(7, 7, '2024-02-02', '2024-10-16', NULL),
(1, 8, '2024-02-03', '2024-08-17', NULL),
(9, 9, '2024-02-04', '2024-06-18', NULL),
(10, 10, '2024-02-05', '2024-05-19', NULL),
